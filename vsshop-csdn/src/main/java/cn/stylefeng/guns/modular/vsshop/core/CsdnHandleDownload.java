...
public class CsdnHandleDownload extends BasicHandleDownload implements HandleDownload {
    ...
    private static final String vipCookie = "uuid_tt_dd=10_30712590160-1552032809776-181493; __yadk_uid=7MjhadlVDIO3CeTg5XgHagOlA3PmlYtT; UM_distinctid=1695ca460b22a-042397c8a7b59c-3d644509-1fa400-1695ca460b33b7; smidV2=20190308182427c5381f777e2439540dcb7a9e31fc1d4700b34cb4c140e9a30; _ga=GA1.2.805468984.1555487986; dc_session_id=10_1560915795729.474287; UserName=lan526; UserInfo=a7aee968d4824fc5b17e7b55b5ecc794; UserToken=a7aee968d4824fc5b17e7b55b5ecc794; UserNick=lan526; AU=B59; UN=lan526; BT=1565318339132; p_uid=U100000; Hm_ct_6bcd52f51e9b3dce32bec4a3997715ac=6525*1*10_30712590160-1552032809776-181493!1788*1*PC_VC!5744*1*lan526; acw_tc=2760826b15655939951235367ebf7e92f8f6eee0c40c100f946a840659b7a3; Hm_ct_e5ef47b9f471504959267fd614d579cd=5744*1*lan526!6525*1*10_30712590160-1552032809776-181493; aliyun_webUmidToken=TA89B19B7374C6417DDFF0F1EAE9B3D4CBF44CA0116303FAABA570F8E43; Hm_lvt_e5ef47b9f471504959267fd614d579cd=1566818793,1566888367; Hm_lpvt_e5ef47b9f471504959267fd614d579cd=1566888367; Hm_lvt_6bcd52f51e9b3dce32bec4a3997715ac=1566887429,1566888291,1566888367,1566888437; dc_tos=pwvw4w; Hm_lpvt_6bcd52f51e9b3dce32bec4a3997715ac=1566890097";
...
//        System.setProperty("https.proxyPort", proxyPort);
    ...
    @Override
    public Map<String,Object> downloadArticleContent(VipArticle vipArticle) throws Exception {
        String originUrl = vipArticle.getDownUrl();
        try {
            Request.Builder builder = new Request.Builder();
            builder.url(originUrl);
            Map<String, String> map = new HashMap<>();
            ...
            //获取文件地址
            Request request = builder.build();
            Response response = httpArticle(request);
            byte[] bytes0 = response.body().bytes();
            String result = new String(ZipUtil.unGzip(bytes0));
            Document doc = Jsoup.parse(result);
            String title = doc.select("title").text();
            String article = doc.getElementsByClass("baidu_pl").toString();
            logger.debug("文章的html内容是===  " + article);
