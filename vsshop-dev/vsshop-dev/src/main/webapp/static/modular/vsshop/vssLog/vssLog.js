...
VssLog.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '网站名称', field: 'siteName', visible: true, align: 'center', valign: 'middle',width:'80px'},
            ...
            {title: '拥有者', field: 'owner', visible: true, align: 'center', valign: 'middle',width:'80px'},
            {title: '客户名称', field: 'customerName', visible: true, align: 'center', valign: 'middle',width:'80px'},
            {title: '网站用户', field: 'userName', visible: true, align: 'center', valign: 'middle',width:'80px'},
            ...
            {title: '资源名称', field: 'name', visible: true, align: 'center', valign: 'middle',width:'300px'},
            {title: '文件大小', field: 'fileSize', visible: true, align: 'center', valign: 'middle',width:'80px'},
            {title: '客户计划', field: 'customerPlanName', visible: true, align: 'center', valign: 'middle',width:'80px'},
            {title: '网站计划', field: 'userPlanName', visible: true, align: 'center', valign: 'middle',width:'80px'},
            {title: '邮件地址', field: 'email', visible: true, align: 'center', valign: 'middle',width:'80px'},
